...
import { ChildType, defaultHtml } from './html';
...
export class HtmlRenderer {
	...
	async render(document: WordDocument, options: Options): Promise<Node[]> {
		...
		this.html = { ...defaultHtml, ...options.html };
		this.styleMap = null;
		this.tasks = [];
...
`
	...
	renderText(elem: WmlText) {
		return this.html.text(elem.text);
	}
	...
	createElementNS(ns: string, tagName: string, props?: Partial<Record<any, any>>, children?: ChildType[]) {
		return this.html.element(ns, tagName, props, children) as any;
	}
	...
	createMathMLElement<T extends keyof MathMLElementTagNameMap>(tagName: T, props?: Partial<Record<keyof MathMLElementTagNameMap[T], any>>, children?: ChildType[]): MathMLElementTagNameMap[T] {
